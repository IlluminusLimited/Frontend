        ...
        <main className="container">
          ...
          <section>
            <h2
              ...
              className="h3-size copy-turquoise with-divider"
            >
            ...
            <p>
              ...
              <a href="https://app-prod.pinster.io">app-prod.pinster.io</a>{" "}
              and/or
              <a href="https://api-prod.pinster.io">api-prod.pinster.io</a>, you
            ...
            <ol type="a">
              <li>
                The materials on Pinster's website are provided on an 'as is'
                basis. Pinster makes no warranties, expressed or implied, and
              ...
              <li>
                Further, Pinster does not warrant or make any representations
            ...
            <p>
              In no event shall Pinster or its suppliers be liable for any
              damages (including, without limitation, damages for loss of data
              or profit, or due to business interruption) arising out of the use
              or inability to use the materials on Pinster's website, even if
              Pinster or a Pinster authorized representative has been notified
            ...
            <p>
              The materials appearing on Pinster's website could include
              technical, typographical, or photographic errors. Pinster does not
              warrant that any of the materials on its website are accurate,
              complete or current. Pinster may make changes to the materials
              contained on its website at any time without notice. However
              Pinster does not make any commitment to update the materials.
            </p>

            <h3 className="h4-size copy-purple">5. Modifications</h3>
            <p>
              Pinster may revise these terms of service for its website at any
            ...
            <p>
              ...
              accordance with the laws of Indiana and you irrevocably submit to
          ...
          <section>
            ...
            <p>
              It is Pinster's policy to respect your privacy regarding any
            ...
            <p>
              ...
              personal information is protected and maintained. Pinster may
              change this privacy policy from time to time at Pinster's sole
              discretion.
            </p>
          </section>
        </main>
