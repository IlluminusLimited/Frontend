        ...
        return (
            <div className="panel panel-default">
                <div className="panel-heading">
                    <h1 className="panel-title ">Legal</h1>
                </div>
                <div className="panel-body">
                    ...
                    <p>By accessing the website at
                        <a href="https://api-dev.pinster.io">https://api-dev.pinster.io</a>,
                        <a href="https://api-prod.pinster.io">https://api-prod.pinster.io</a>, you are
                        agreeing
                        to
                        be
                ...
                <button className="btn-load-more" onClick={this.props.history.goBack}>Back</button>
            </div>
        );
    }
}
