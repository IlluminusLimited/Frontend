            ...
            <main class="container">
                <div class="login-splash full-bleed">
                    ...
                    >
                        ...
                        <path
                            class="ears"
                            d="M28.75 11.91s-5 1.31-6.78 3.71c0 0-3.5-5.68 1.1-10.28 0 0 3.93 1.32 5.68 6.57zm36.36 3.71c-1.75-2.4-6.78-3.71-6.78-3.71C60.08 6.66 64 5.34 64 5.34c4.61 4.6 1.11 10.28 1.11 10.28z"
                        />
                        <path
                            class="eyes"
                            d="M60.92 21.1c-19.48 2-6.79 22.53 2.84 20.34s11.54-21.8-2.84-20.34zm-.23 15.31a3.07 3.07 0 1 1 3.07-3.06 3.06 3.06 0 0 1-3.07 3.06zM29.2 21.1c-14.39-1.46-12.47 18.15-2.84 20.34S48.68 23.07 29.2 21.1zm.22 15.31a3.07 3.07 0 1 1 3.06-3.06 3.06 3.06 0 0 1-3.06 3.06z"
                        />
                        <path
                            class="nose"
                            d="M46.48 33.57c-5-.66-9.2 3.06-7.66 8.75s7.87 7.88 11.38 3.5 1.95-11.51-3.72-12.25zM43 37.72c-2.4-3.72 5.48-3.5 5.48-1.09-.03 1.76-3.1 4.81-5.48 1.09z"
                        />
                        <path
                            class="belly"
                            d="M54.83 78.11c0 3.67-17.62 5.14-18.71 1.47s-.73-24 9.09-23.87c7.79.15 9.62 18.73 9.62 22.4z"
                        />
                    </svg>
                    <h1>pinster</h1>
