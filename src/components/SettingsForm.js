        ...
        return (
            <form className="my-settings" onSubmit={this.handleSubmit}>
                <div className="form-group">
                    ...
                    <input type="text" id="display_name" name="display_name" defaultValue={this.state.display_name} onChange={this.handleChange} />
                </div>
                <div className="form-group">
                    <label htmlFor="bio">bio</label>
                    <textarea id="bio" name="bio" rows="8" onChange={this.handleChange} defaultValue={this.state.bio}></textarea>
                </div>
                <div className="form-group">
                    <label htmlFor="email">email</label>
                    <input type="email" id="email" name="email" defaultValue={this.state.email} onChange={this.handleChange} />
                </div>
